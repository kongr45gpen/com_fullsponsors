...
class ManagedsponsorsViewSponsor extends JViewLegacy
{
	...
	protected function setDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_managedsponsors/assets/css/sponsor.css", (ManagedsponsorsHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css'); 
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_managedsponsors/views/sponsor/submitbutton.js", (ManagedsponsorsHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
