 ...
 * Sponsor Controller
 */
class ManagedsponsorsControllerSponsor extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'all_sponsors'; // safeguard for setting the return view listing to the default site view.
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Sponsor', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_managedsponsors&view=sponsors' . $this->getRedirectToListAppend(), false));
